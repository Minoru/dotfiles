" Vim color file based on my lack of sence of beautiful :)
" Maintainer: Alexander Batischev

" This is written with 256-color terminal in mind (specifically RXvt with
" Unicode and 256 colors support). No other terminals (let alone GUIs) were
" tested.
...
let g:colors_name="minoru"

" The following code is stolen from 'badwolf' colorscheme by Steve Losh
...
call s:HL('TabLineFill', 'mediumgravel', s:tabline, 'underline')
